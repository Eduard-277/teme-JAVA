...
/**
 * Meniu de gestionare a stocului de echipamente
 * @author Eduard
 * @version 1
 * @since 2024
 */
...
public class Main {
    ...
    /**
     * Afiseaza in linia de comanda toate echipamentele
     * @param echipamente lista cu informatii despre fiecare echipament
     */
    ...
    /**
     * Afiseaza in linia de comanda toate imprimantele
     * @param echipamente lista cu informatii despre fiecare echipament
     */
    ...
    /**
     * Afiseaza in linia de comanda toate copiatoarele
     * @param echipamente lista cu informatii despre fiecare echipament
     */
    ...
    /**
     * Afiseaza in linia de comanda toate sistemele de calcul
     * @param echipamente lista cu informatii despre fiecare echipament
     */
    ...
    /**
     * Obtine obiectul de tip imprimanta cautat dupa ordinea gasirii acestora in lista de echipamente
     * @param echipamente Lista cu informatii despre fiecare echipament
     * @param nr A cata imprimanta trebuie gasit in lista de echipamente
     * @return  Obiectul de tip imprimanta cautat
     */
    ...
    /**
     * Obtine obiectul de tip copiator cautat dupa ordinea gasirii acestora in lista de echipamente
     * @param echipamente Lista cu informatii despre fiecare echipament
     * @param nr Al catelea copiator trebuie gasit in lista de echipamente
     * @return Obiectul de tip copiator cautat
     */
    ...
    /**
     * Obtine obiectul de tip sistem_de_calcul cautat dupa ordinea gasirii acestora in lista de echipamente
     * @param echipamente Lista cu informatii despre fiecare echipament
     * @param nr Al catelea sistem_de_calcul trebuie gasit in lista de echipamente
     * @return Obiectul de tip sistem_de_calcul cautat
     */
    ...
    /**
     * Afisarea echipamentelor care au fost vandute
     * @param echipamente Lista cu informatii despre fiecare echipament
     */
    ...
    /**
     * Serializarea listei de echipamente
     * @param o Lista de echipamente care e serializata
     * @param fis Fisierul in care se salveaza informatia de tip binar
     */
    ...
    /**
     * Deserializarea listei de echipamente
     * @param fis Fisierul in care e salvata informatia de tip binar
     * @return Lista cu echipamentele din fisierul binar
     */
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        OS os;
/**
 * Citirea informatiei din fisier si asezarea echipamentelor intr-o lista
 */
...
/**
 * Realizarea meniului pentru consola
 */
        do{
            ...
            switch(s) {
                ...
                case 5:
                    /**
                     * Modificarea starii a unui echipament selectat
                     */
                    afisare_echipamente(echipamente);
                ...
                case 6:
                    /**
                     * Modificarea modului de tiparire a unei imprimante selectate
                     */
                    afisare_imprimante(echipamente);
                ...
                case 7:
                    /**
                     * Modificarea formatului de tiparire a unui copiator selectat
                     */
                    afisare_copiatoare(echipamente);
                ...
                case 8:
                    /**
                     * Instalarea unui sistem de operare pe un sistem_de_calcul selectat
                     */
                    afisare_sistem_de_calcul(echipamente);
